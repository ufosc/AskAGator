defmodule AskAGatorBackendWeb.Schema do
  use Absinthe.Schema

  alias AskAGatorBackendWeb.UserResolver
  alias AskAGatorBackendWeb.CourseResolver
  import_types(AskAGatorBackendWeb.Schema.DataTypes)
